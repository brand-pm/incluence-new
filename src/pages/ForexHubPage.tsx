...
const JURISDICTIONS = [
  { reg: "CySEC", name: "Cyprus", badge: "EU Regulated", desc: "Most popular EU forex license. Passporting rights across all 27 EU member states under MiFID II. Access to European payment infrastructure.", price: "From €35,000", timeline: "6–9 months", href: "/cyprus-forex-license" },
  { reg: "MFSA", name: "Malta", badge: "EU Regulated", desc: "MiFID II compliant license from the Malta Financial Services Authority. Strong EU market access with favorable corporate tax regime.", price: "From €30,000", timeline: "5–7 months", href: "/forex-broker-licence-in-malta" },
  { reg: "VFSC", name: "Vanuatu", badge: "Offshore", desc: "Three license classes covering forex, futures, commodities and precious metals. Fast process, low capital requirements, favorable environment.", price: "From $15,000", timeline: "2–3 months", href: "/forex-broker-licence-in-vanuatu" },
  { reg: "SEC", name: "Montenegro", badge: "Emerging", desc: "Competitive licensing environment with straightforward regulatory process. EU candidate country with growing acceptance among brokers.", price: "From €20,000", timeline: "4–7 months", href: "/forex-broker-licence-in-montenegro" },
  { reg: "FSC", name: "Mauritius", badge: "Offshore", desc: "Reputable offshore jurisdiction regulated by the Financial Services Commission. Allows forex, options, futures and securities trading.", price: "From $20,000", timeline: "3–6 months", href: "/forex-broker-licence-in-mauritius" },
  { reg: "FSAS", name: "Seychelles", badge: "Offshore", desc: "Fast and cost-effective license from the Financial Services Authority. Minimal capital requirements with broad trading permissions.", price: "From $10,000", timeline: "2–3 months", href: "/forex-license-seychelles" },
];
