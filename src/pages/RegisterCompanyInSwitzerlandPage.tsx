...
const PAGE_DATA = {
  ...
  description: `What is the benefit of registering a company in Switzerland: Company features Starting a business in Switzerland is the best option for entrepreneurs looking for trouble-free company registration and simple working conditions.`,
  requirements: [
  ...
  faq: [
    ...
    { question: `How to start a business in Switzerland?`, answer: `In order to register a business in Switzerland, you need to choose a name of the future company that is free for registration, collect a package of documents, and pay the necessary fees. After registering a company, you need to open a bank account. I` },
