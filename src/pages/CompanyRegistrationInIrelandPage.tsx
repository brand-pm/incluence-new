...
// Source: https://www.incluence.com/company-registration-in-ireland (1:1 copy)
const PAGE_DATA = {
  title: `Company Registration in Ireland`,
  description: `Relatively low corporate tax rates make Ireland an attractive location for business. Many prominent businesspeople also note other significant advantages of the jurisdiction:
...
If you have questions, submit a form and our experts will contact you promptly.`,
  sections: [
    {
      heading: `01. Choosing a Name for the Future Company in Ireland`,
      body: `The client must provide 3 name options. We will check their availability for registration and suggest free options for final selection. If all three are taken, additional options will be requested. Providing 3 names is not mandatory but speeds up the verification process.`,
    },
    {
      heading: `02. Preparing Documents`,
      body: `The client must prepare personal documents for company registration. This can be done alongside stage 1. The exact list depends on the company specifics. Usually, a passport copy and proof of address are required. In some cases, online verification may be needed.`,
    },
    {
    ...
    {
      heading: `04. Submitting Registration Documents`,
      body: `The completed package is submitted to the Registry. The registrar processes the documents, and the company is entered into the Registry database.`,
    },
    {
      heading: `05. Receiving Confirmation of Company Registration`,
      body: `Once the company is entered into the Registry, its registration data can be viewed, and certified or non-certified paper copies of the statutory documents can be requested. Our specialists assist with notarization, apostille, and translations if required.`,
    },
    {
      heading: `06. Taxes Paid by a Limited Company`,
      body: `For LTDs in Ireland, corporate tax rates are:`,
    },
    {
      heading: `07. Important Notes for Opening an LTD in Ireland`,
      body: `- Dividends taxed at 12.5% corporate tax are considered such if received from a subsidiary trading company in Europe.
