...
// Source: https://www.incluence.com/register-company-in-singapore (1:1 copy)
const PAGE_DATA = {
  title: `Register company in Singapore`,
  description: `Before registration of company in Singapore, you should study general information about this state — find out the current languages and study the legal system. Please note that the local currency is the Singapore dollar, but there is no currency control.
...
If you plan to register a company in Singapore, you must, first of all, choose the right form of business. If you define the structure correctly, the organization can operate offshore or onshore, as well as fall under low rates of taxation.`,
  sections: [
    {
      heading: `01. Choosing a name for a future company in Singapore`,
