...
import { SingaporeCompanyVisual } from "@/components/templates/heroVisuals";


// Source: service-texts.md | URL: /register-company-in-singapore
const PAGE_DATA = {
  title: `Register company in Singapore`,
  description: `Before registration of a company in Singapore, you should study general information about this state. The local currency is the Singapore dollar, and there is no currency control.`,
  sections: [
    {
      heading: `Registration of companies in Singapore`,
      body: `Before registration of company in Singapore, you should study general information about this state \u2014 find out the current languages and study the legal system. Please note that the local currency is the Singapore dollar, but there is no currency control.\n\nIf you plan to register a company in Singapore, you must, first of all, choose the right form of business. If you define the structure correctly, the organization can operate offshore or onshore, as well as fall under low rates of taxation.`,
    },
  ],
  requirements: [
...
const RegisterCompanyInSingaporePage = () => (
  <ServiceDetailPage
    slug="register-company-in-singapore"
