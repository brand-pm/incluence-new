...
// Source: https://www.incluence.com/company-registration-in-cyprus (1:1 copy)
const PAGE_DATA = {
  title: `Company Registration in Cyprus`,
  description: `Starting a business in Cyprus involves many nuances. The local legal system is quite complex. Incluence Limited specialists will help you choose the right path for company registration. Our experts have extensive experience in legal services and are ready to assist you at all stages of cooperation.

We will provide consultations on the collection and submission of documents, registration forms in accordance with current legislation. This allows our clients to be confident in the successful establishment of their business. Later, during the course of business operations, we are ready to provide competent and timely legal support.
...
- The cost of registering substance — the actual business presence of a legal entity at the place of registration — is relatively low.
...
Corporation Tax, established at 12.5%, is paid by resident organizations regardless of the type of activity and the source of income — whether on the territory of the state or abroad.

_It is possible to register non-resident companies in Cyprus. Foreign firms pay tax based on the amount of income received from activities on the island. However, non-resident organizations are often viewed unfavorably by banks. Therefore, they may not be able to use all the benefits of double-taxation treaties. Thus, opening a resident company in Cyprus is considered the most promising option._
...
- Capital Gains Tax — tax on capital gain paid after the sale of real estate on the island or shares of companies owning such property. The tax rate is 20%.
...
If you plan to open a company in Cyprus, the cost of our services includes the full range of necessary actions. We suggest discussing your project — contact us using the corresponding online form.`,
  sections: [
    {
      heading: `01. Choosing a name for the future company in Cyprus`,
      body: `The client must provide 3 options for the company name. We will check the availability of these options for registration and suggest available ones for final selection. If all three are taken, we will request additional options. Providing 3 names is not a mandatory requirement, but it will speed up the verification process.`,
    },
    {
      heading: `02. Preparing documents`,
      body: `The client must prepare personal documents for company registration. This can be done in parallel with stage one. The exact list depends on the specifics of the future company. Typically, a copy of the passport, proof of address of the participants, and a power of attorney are required.`,
    },
    {
      heading: `03. Preparing registration forms`,
      body: `Based on the data provided by the client, a set of documents is prepared for submission to the Register.`,
    },
    {
      heading: `04. Submitting documents for registration`,
      body: `The completed set of documents is submitted to the Register. After this, the registrar processes the documents and the company is entered into the Register database.`,
    },
    {
      heading: `05. Receiving confirmation of company registration`,
      body: `After the company is entered into the Register, its registration data can be viewed, and statutory documents can be requested in paper form with or without certification. Our specialists will assist with all necessary certifications (notarization, apostille) and translations if required.`,
    },
    {
