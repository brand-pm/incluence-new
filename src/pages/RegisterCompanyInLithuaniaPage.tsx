...
const PAGE_DATA = {
  ...
  description: `What company registration in Lithuania is the most suitable? Lithuania company registration allows business people to enter the European market and successfully develop their businesses.`,
  requirements: [
    `What company registration in Lithuania is the most suitable?`,
