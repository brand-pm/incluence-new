...
const PAGE_DATA = {
  ...
  faq: [
    { question: `What are the terms for opening a company in Lithuania?`, answer: `The terms for opening a company in Lithuania depends on the type of company's activity and is around 3-4 weeks.` },
    ...
    { question: `What documents do I need to register a company in Lithuania?`, answer: `You must submit copies of passport of company's participants. It is also necessary to submit completed registration forms.` },
  ],
};
