...
import { MauritiusForexHeroVisual } from "@/components/templates/heroVisuals";
...
const FAQS = [
  { q: "What are the requirements for obtaining a Forex license in Mauritius?", a: "In order to obtain a forex license in Mauritius, it is necessary to register a company, prepare policies, technical documentation and other documents. After opening an account and depositing the authorized capital, submit an application to the regulator. After obtaining a license, it is necessary to show the activity of the company in order to avoid its cancellation." },
  { q: "What documents are required to obtain a Forex license in Mauritius?", a: "In order to obtain a forex license in Mauritius, the following documents are required: the company's statutory documents, business plan, AML policy, rules for using the resource, confirmation of the identity and experience of the company's participants, technical documentation." },
  { q: "How long will it take to get a Forex license in Mauritius?", a: "The approximate period for obtaining a forex license in Mauritius is 6 months. The time of receipt is affected by the speed of preparation of documents and consideration of the application by the regulator." },
  { q: "How much does an investment license in Mauritius cost?", a: "The final cost of obtaining an investment license in Mauritius is influenced by various factors (the exact list of future services, the region of work, etc.). You can find out the exact cost of obtaining an investment license in Mauritius by contacting our specialists." },
];
const RELATED = [
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto py-[88px] px-12">
          <div className="grid grid-cols-12 gap-8 items-center">
            <div className="col-span-7">
              ...
              <p className="text-[15px] text-[#9A9590] leading-[1.8] max-w-[480px] mb-8">If you decide to do business in the financial or capital markets, you must have a license to operate even in offshore jurisdictions. Companies registered in Mauritius can apply for a license that allows them to operate legally with options, securities, and futures. It is also the document that authorizes companies to trade in foreign exchange markets.</p>
        ...
        <div className="max-w-screen-xl mx-auto py-[72px] px-12 grid grid-cols-12 gap-12">
          <div className="col-span-7">
            ...
            <div className="space-y-4 text-[14px] text-[#9A9590] leading-[1.85]">
              <p>Mauritius Financial Services Commission (FSC) grants Mauritius Forex license to companies. This body regulates the non-banking financial services sector, insurance market, pension fund, and other businesses. The regulatory body is responsible for licensing companies that meet the government's requirements and submit the following documents along with the application:</p>
              <p>The company's memorandum and articles of association. A description of the internal control system. A business plan listing prospective customers, suppliers, planned marketing, recruitment mechanisms, etc. Results of personnel testing for professional aptitude and compliance with certain skills, experience, and qualifications required to perform the job duties.</p>
            </div>
          </div>
