...
import { UKCompanyVisual } from "@/components/templates/heroVisuals";
...
const PAGE_DATA = {
  ...
  faq: [
    ...
    { question: `How to register a company in the UK?`, answer: `It is necessary to submit to the registry data and documents of directors, shareholders and beneficiaries of the company, indicate the British address, describe the company itself in order to register a company in the UK. Registration requires a prior authorization. A company in Britain can be easily and quickly registered with the assistance of experienced intermediaries.` },
    ...
    { question: `How to check company registration in the UK?`, answer: `All existing UK companies, as well as liquidated companies, are visible in the Companies House register. Anyone can check a company by name for free and without registration. The name, date of registration, registration number and participants of the company are visible in the register.` },
  ],
};
