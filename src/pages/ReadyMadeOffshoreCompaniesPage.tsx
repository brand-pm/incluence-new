...
// Source: https://www.incluence.com/ready-made-offshore-companies (1:1 copy)
const PAGE_DATA = {
  title: `Ready-made offshore companies`,
  description: `Incluence specialists offer a turnkey company purchase service — the simplest way to become the owner of a foreign company in an offshore jurisdiction. The obvious advantage is that you do not need to go through company registration procedures, lengthy paperwork, and so on.
...
Our specialists take all these nuances into account and will help you choose suitable ready-made offshores. We offer companies in many jurisdictions, so we can easily find the right option for you.`,
  sections: [
    {
      heading: `01. Choosing a company`,
      body: `You need to find a company to purchase and discuss the terms of the deal. This can be done either independently or with our assistance. We have clients and partners who are looking for buyers for their companies.`,
    },
    {
      heading: `02. Company audit`,
      body: `Before buying, the company should be checked for debts to government authorities, including tax obligations, as well as receivables and payables.`,
    },
    {
      heading: `03. Document preparation`,
      body: `You need to prepare the buyer’s personal documents (passport, proof of address, letters of recommendation), and forms for re-registration.`,
    },
    {
      heading: `04. Submitting documents for re-registration`,
      body: `The collected package of documents is submitted to the Registry. After that, the registrar processes the documents and the changes to the company are entered into the Registry’s database.`,
    },
    {
      heading: `05. Receiving confirmation of company re-registration`,
      body: `After the company’s data has been updated in the Registry, its registration details can be viewed there, and if necessary, you can order paper versions of statutory documents with or without certification. Incluence specialists will assist with all required certifications (notarial, apostille) and, if needed, translations into other languages.`,
    },
    {
      heading: `06. **Where to buy an offshore: classic options**`,
      body: `This group includes countries that exempt companies registered in their territory from taxes. At the same time, when buying an offshore company, entrepreneurs must remember that business activity must be conducted outside the country of registration. Tax exemption is granted only under these conditions.`,
    },
    {
      heading: `07. **Ready-made offshore companies with tax incentives**`,
      body: `You can also buy a ready-made company in a so-called “midshore” jurisdiction, which enjoys international respectability while still offering attractive tax incentives to business owners. To gain these benefits, simply choose one of the countries in this group. If such offshores interest you, companies can be purchased in midshore jurisdictions such as the United Kingdom and Hong Kong.`,
    },
    {
      heading: `Additional services — Offshore company formation in St Vincent and the Grenadines`,
      body: `Saint Vincent and the Grenadines is an independent state in the Caribbean islands. It attracts business people with favorable taxation for non-residents, loyal legislation, and some additional features related to international business activities.`,
    },
    {
      heading: `Additional services — Offshore company formation in Seychelles`,
      body: `Seychelles is a favorable jurisdiction with minimal company maintenance costs. Entrepreneurs can set up and develop an efficient business structure with reliable asset protection here as this offshore zone is characterized by stability in political and administrative spheres. The government retains the policy of supporting offshore businesses, which is an additional advantage for entrepreneurs. Today, offshore companies in Seychelles are available to business people in several organizational and legal forms. In addition, one can both register a company in Seychelles and buy a ready-made business in Seychelles to start operating in the shortest possible time.`,
    },
    {
      heading: `Additional services — Opening an Offshore Bank Account`,
      body: `Today, companies registered in offshore jurisdictions can open accounts that allow businesses to perform payment operations. Clients’ personal data remains confidential, and anyone can open an offshore account. However, it should be noted that banks’ requirements for corporate clients and individuals may differ significantly.`,
    },
  ],
  faq: [
