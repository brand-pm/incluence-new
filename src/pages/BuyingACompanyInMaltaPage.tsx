...
const BuyingACompanyInMaltaPage = () => (
  <ServiceDetailPage
    ...
    faq={[
      {
        question: "What documents are required to purchase a business in Malta?",
        answer: "To purchase a business in Malta, you must provide copies of the participants' passports and proof of address. You must also submit completed forms for re-registration of the company.",
      },
      {
        question: "How long does the process of purchasing a company in Malta take?",
        answer: "The re-registration process of a company in Malta takes up to 3 weeks.",
      },
      {
        question: "What taxes must be paid when buying a company in Malta?",
        answer: "When purchasing a company in Malta, you only need to pay the registration fee. Tax obligations arise only after the company begins operations or if the previous owner failed to pay taxes for prior activities.",
      },
      {
        question: "Can I buy a company in Malta online?",
