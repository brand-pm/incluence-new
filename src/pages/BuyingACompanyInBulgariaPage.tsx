...
const BuyingACompanyInBulgariaPage = () => (
  <ServiceDetailPage
    ...
    description="Today, Bulgaria offers a favorable business environment, largely due to the simplicity and convenience of most processes necessary for enterprises."
    sections={[
      {
        heading: "How to Profitably Buy a Company in Bulgaria",
    ...
    faq={[
      {
        question: "What documents are required to buy a business in Bulgaria?",
        answer: "To buy a business in Bulgaria, you need to provide copies of the shareholders' passports, proof of address, tax number, and certified registration forms.",
      },
      {
        question: "How long does the process of buying a company in Bulgaria take?",
        answer: "The process of buying a company in Bulgaria takes 3\u20134 weeks.",
      },
      {
        question: "What taxes must be paid when buying a company in Bulgaria?",
        answer: "When purchasing a company in Bulgaria, only the registration fee needs to be paid. Tax obligations arise only after the company starts its activities or if the previous owner failed to pay taxes related to past operations.",
      },
      {
        question: "Can a company in Bulgaria be purchased online?",
