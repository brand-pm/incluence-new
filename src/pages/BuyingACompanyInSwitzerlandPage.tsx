...
const BuyingACompanyInSwitzerlandPage = () => (
  <ServiceDetailPage
    ...
    faq={[
      {
        question: "What documents are required to buy a business in Switzerland?",
        answer: "To purchase a company in Switzerland, you must provide copies of the participants' passports and proof of address. Completed registration forms including information on the source of funds are also required. Beneficiaries may be asked to provide confirmation of the origin of funds for company establishment.",
      },
      {
        question: "How long does the process of buying a company in Switzerland take?",
        answer: "Buying a company in Switzerland takes about 2\u20133 weeks.",
      },
      {
        question: "What taxes must be paid when buying a company in Switzerland?",
        answer: "When buying a company in Switzerland, you only need to pay the registration fee. Tax obligations arise only after the company begins its activity or if the previous owner failed to pay taxes on prior activities.",
      },
      {
        question: "Can I buy a company in Switzerland online?",
