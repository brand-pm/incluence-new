...
const BuyingACompanyInCanadaPage = () => (
  <ServiceDetailPage
    ...
    faq={[
      {
        question: "How to re-register a ready-made company in Canada?",
        answer: "To re-register a company in Canada, the seller and buyer must either issue a power of attorney or visit Canada, prepare a copy of their passport, and complete the re-registration forms. The completed documents must then be submitted to the Registry.",
      },
      {
        question: "What documents are required to purchase a company in Canada?",
        answer: "To purchase a company in Canada, copies of the participants' passports and proof of address must be submitted. Registration forms must also be completed, including information about the source of financing for the company's creation. During re-registration, beneficiaries may be required to provide proof of the origin of funds used to acquire the company.",
      },
      {
        question: "What taxes need to be paid when buying a company in Canada?",
        answer: "When buying a company in Canada, only the registration fee must be paid. Tax obligations arise only after the company begins operations, or if the previous owner failed to pay taxes on past activities.",
      },
      {
        question: "Can a company in Canada be purchased online?",
