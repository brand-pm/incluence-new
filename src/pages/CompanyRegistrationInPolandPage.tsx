...
- You will need to travel to the country twice: to register the company and to open a bank account for depositing share capital. The statutory minimum share capital is set at 5,000 PLN — one of the lowest in the European Union.
- **By proxy.*.
- This requires a power of attorney for a Polish representative, notarized copies of passports translated into Polish, as well as a bank statement.
...
- It is best to prepare several options to increase the chances of finding an available one in the Register.
- **Preparing documents.*.
- Most likely, notarized copies of participants’ identity documents will be required. The complete package is determined individually depending on the chosen legal form.
- **Filling out registration forms.*.
- Accuracy is crucial, otherwise registration may be denied.
- **Submitting documents to the Register.*.
- If the package meets requirements, the company’s data is entered into the Register. Confirmation of successful registration appears in official sources. At this point, statutory documents can be printed and business activities can commence.
