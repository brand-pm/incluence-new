...
const CONDITIONS = [
  "Company details, information about its participants, and future business activities",
  "Upload personal documents of participants and the company's corporate documents",
  "Pass verification — KYC and AML compliance review by the payment system or bank",
  "In some systems: a bank account may be required at the time of review (requirement varies)",
];

const FAQS = [
  { q: "What are the conditions for opening an account in payment systems?", a: "Provide company details, participant information and future business activities. Upload personal and corporate documents. Pass verification. Some systems require a bank account, but this is rare." },
  { q: "Which payment systems do you work with?", a: "We work with various payment systems registered in the EU, USA, UK, Hong Kong, Singapore and other countries. We select based on your company's specifics, currencies, payment regions, and other factors." },
  { q: "Is it necessary to have a bank account to open a payment system account?", a: "Usually no — payment system accounts are opened independently. However, having a bank account and business history can speed up the process. Some systems require a bank account, but this is rare." },
  { q: "Can a payment system account be opened online?", a: "Yes. Payment systems usually open accounts online, making them a faster and more accessible alternative to traditional bank accounts for many business types." },
];
    ...
    <div style={{ fontFamily: "Manrope, sans-serif" }}>
      ...
      <section className="bg-[#080808] relative overflow-hidden" style={{ padding: "80px 48px" }}>
        ...
        <div className="max-w-screen-xl mx-auto relative z-10">
          ...
          <p className="text-[15px] text-[#9A9590] max-w-[500px] mb-10 leading-[1.8]">
            Incluence provides services in international tax planning, asset protection, registration and maintenance of foreign companies, and opening bank accounts worldwide. Contact us to open a foreign bank account with minimal risk of denial.
          </p>
      ...
      <section className="bg-[#0d0d0d]" style={{ padding: "72px 48px" }}>
        <div className="max-w-screen-xl mx-auto">
          ...
          <p className="text-[14px] text-[#9A9590] mb-10 max-w-[540px] leading-relaxed">The exact conditions depend on the rules of the chosen payment system or bank. Typically you need to provide:</p>
        ...
        <div className="max-w-screen-xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
            <div className="md:col-span-7">
              ...
              <p className="text-[14px] text-[#9A9590] leading-[1.85]">If you have decided to open a foreign bank account, please contact our specialists because document requirements include only basic items — in most situations, many other documents are required. This procedure should be entrusted to professionals to minimize the risk of denial.</p>
            </div>
            <div className="md:col-span-5">
              <div className="bg-[#080808] border border-white/[0.06] p-7 group relative overflow-hidden">
                ...
                <p className="text-[13px] text-[#9A9590] leading-relaxed mb-4">Payment systems usually open accounts online. If you need an account quickly or are facing difficulties with traditional banking, a payment system account is a viable alternative.</p>
                <p className="text-[13px] text-[#9A9590] leading-relaxed">We work with payment systems in the EU, USA, UK, Hong Kong, Singapore and other countries — selected based on your specific company needs.</p>
