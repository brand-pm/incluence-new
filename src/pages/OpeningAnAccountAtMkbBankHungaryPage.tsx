...
const PAGE_DATA = {
  ...
  faq: [
    { question: `What is required to open an account at MKB Bank?`, answer: `You must complete and submit the bank’s KYC and AML forms, company statutory documents, and personal documents of directors and beneficiaries. The bank may also request contracts with partners. Key persons must undergo verification.` },
    ...
    { question: `How long does it take to open an account at MKB Bank?`, answer: `The time required depends on the company’s specifics and the speed of responses to the bank’s inquiries. On average, the process takes about 2 months.` },
  ],
};
