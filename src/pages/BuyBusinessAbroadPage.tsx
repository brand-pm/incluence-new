...
// Source: https://www.incluence.com/buy-a-business-abroad (1:1 copy)
const PAGE_DATA = {
  title: `Buy a business abroad`,
  description: `Thanks to the constant development of the economy and various technologies, new business opportunities open up before business people almost every day. It is enough to implement them promptly to get a certain profit. As a rule, when a business model is successfully tested within one country, entrepreneurs strive to occupy a niche in the international market before their competitors do so.Discuss the project

50+

Successful cases to resolve problems with banks, stock exchanges and tax authorities
...
Returned to customers or saved with our help

5years

Payment systems and international transaction business
...
If you decide to buy a business abroad with no liabilities and some reputation in the market, contact us for the purchase and sale transaction and the subsequent re-registration of the company. We will do everything necessary so that you can start your business quickly and make a profit from the activity of your company.`,
  sections: [
    ...
    {
      heading: `06. Buy company in Estonia`,
    ...
    {
      heading: `11. Buying a Company in Bulgaria`,
  ...
  faq: [
    { question: `How much will it cost to buy a ready-made company?`, answer: `The final cost of a ready-made company is influenced by the country of incorporation, the period of existence, the presence of previous activities and accounts, and other factors. You can find out the exact cost of a ready-made company by contacting our specialists.` },
    { question: `Is it possible to buy a ready-made business online?`, answer: `Detailed conditions for re-registration of a company depend on the legislation of the country of registration. Typically, companies are re-registered by local representatives on the basis of a power of attorney. Also, the company can be re-registered during a personal visit to the registrar in the desired country. In some countries, the company can be transferred through the local representative by scanned documents.` },
    { question: `In which countries do we help with the purchase of a ready-made company?`, answer: `We assist with the purchase of ready-made companies around the world, including EU countries, European non-EU countries, Asian countries, USA, Australia and Oceania, offshore.` },
    { question: `How long does it take to buy a ready-made company?`, answer: `The duration of the process of a ready-made company purchase depends on the state of the company, the country of registration and the characteristics of new and old participants. Usually the duration of re-registration takes up to 1 month.` },
  ],
};

const BuyBusinessAbroadPage = () => (
  <ServiceDetailPage
    slug="buy-a-business-abroad"
