  ...
  return (
    <div style={{ fontFamily: "Manrope, sans-serif" }}>
      ...
      <section className="relative overflow-hidden" style={{ background: "#080808", padding: "88px 48px", minHeight: 520 }}>
        ...
        {/* Estonia SVG map */}
        <svg className="absolute right-[8%] top-1/2 -translate-y-1/2 w-[340px] h-[380px] pointer-events-none z-[2] opacity-[0.08]" viewBox="0 0 340 380" fill="none">
          ...
          <text x="260" y="158" textAnchor="middle" fill="#444CE7" fillOpacity="0.3" fontSize="6" fontFamily="Manrope">FIU HQ</text>
          <text x="170" y="240" textAnchor="middle" fill="#F0EBE0" fillOpacity="0.06" fontSize="28" fontFamily="Manrope" fontWeight="300">EE</text>
          <text x="170" y="260" textAnchor="middle" fill="#444CE7" fillOpacity="0.15" fontSize="8" fontFamily="Manrope">EU · Baltic</text>
        </svg>
      ...
      <section style={{ background: "#111111", padding: "72px 48px" }}>
        <div className="max-w-screen-xl mx-auto">
          ...
          <h2 className="text-[clamp(24px,3vw,40px)] font-light text-[#F0EBE0] mb-4">How to Obtain an Estonia VASP License</h2>
      ...
      <section style={{ background: "#080808", padding: "88px 48px" }}>
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5">
            ...
            <h2 className="text-[clamp(24px,3vw,40px)] font-light text-[#F0EBE0] mb-4">Apply for an Estonia Crypto License</h2>
