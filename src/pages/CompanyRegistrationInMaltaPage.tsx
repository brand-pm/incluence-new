...
const PAGE_DATA = {
  ...
  faq: [
    ...
    { question: `What documents are required to register a company in Malta?`, answer: `In order to register a company in Malta, you must submit a copy of passport and confirmation of the address of each participant. It is also necessary to submit completed registration forms, including information about the source of funding.` },
