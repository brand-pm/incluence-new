...
const PAGE_DATA = {
  ...
  description: `Start a business in Malta The Republic of Malta is an up-and-coming jurisdiction notable for legitimate ways to optimize taxation. At the same time, the Maltese islands are located on the trade routes between Europe, Africa, and Asia.`,
  requirements: [
