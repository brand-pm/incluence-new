...
const PAGE_DATA = {
  ...
  description: `Company registration in Hungary One of the best options for people wishing to open a company in Europe is to start a business in Hungary. Has about 70 agreements on the avoidance of double taxation.`,
  requirements: [
