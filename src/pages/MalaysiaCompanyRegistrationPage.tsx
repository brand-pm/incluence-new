...
// Source: https://www.incluence.com/malaysia-company-registration (1:1 copy)
const PAGE_DATA = {
  title: `Online Company Registration Malaysia for Foreigners - Incluence`,
  description: `Company registration Malaysia 🇲🇾 Expert services to legally form, register, and manage your business efficiently, ensuring compliance and smooth operations.
