...
const PAGE_DATA = {
  ...
  description: `Starting a business in Montenegro Montenegro is a country in southeastern Europe that attracts hundreds of thousands of tourists annually. It is noteworthy that the locals understand both English and Russian.`,
  requirements: [
  ...
  faq: [
    { question: `How to open a business in Montenegro?`, answer: `In order to register a business in Montenegro, you need to choose a name of the future company that is free for registration, collect a package of documents, and pay the necessary fees. After registering a company, you need to open a bank account. If` },
