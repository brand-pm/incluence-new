...
Fill out the online form or contact our consultants using the details on our website. After the transaction, we are ready to support clients both with advisory services and in actual business operations.`,
  sections: [
    {
      heading: `01. Choosing a Company in Germany`,
      body: `You need to select a company to purchase and discuss transaction terms. This can be done independently or with our assistance. We have clients and partners seeking buyers for their companies.`,
    },
    {
      heading: `02. Company Audit`,
      body: `Before buying, the company should be checked for debts to government agencies, including tax authorities, as well as outstanding receivables and payables.`,
    },
    {
    ...
    },
    {
      ...
      body: `The collected package of documents is submitted to the Register. The registrar processes the documents and updates the company’s information in the database.`,
    },
    {
      heading: `05. Receiving Confirmation of Company Re-Registration`,
      body: `Once the company’s data is updated in the Register, its registration details can be viewed and, if needed, statutory documents can be ordered in paper form with certification or without. Our specialists can assist with all necessary certifications (notarization, apostille) and translations into other languages if required.`,
    },
    {
