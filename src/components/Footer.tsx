...
const Footer = () => (
  <footer className="border-t border-border bg-surface py-24 px-6 lg:px-12">
    <div className="mx-auto grid max-w-[1400px] grid-cols-1 gap-12 md:grid-cols-4">
      ...
      <div>
        <h4 className="text-label text-muted-foreground mb-5">Jurisdictions</h4>
        <ul className="space-y-3">
      ...
      <div>
        ...
        <div className="mt-8 text-body-xs text-muted-foreground">
    ...
    <div className="mx-auto max-w-[1400px] mt-16 pt-8 border-t border-border text-body-xs text-muted-foreground flex flex-col md:flex-row justify-between gap-4">
